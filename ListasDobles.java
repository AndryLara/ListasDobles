...
public class ListasDobles {//me base de sus diapos, de emi y de erick, la verdad lo hicimos en llamada. Pero si entendi. usted pregunte easy todo
    Nodo topForward;
    Nodo topBackward;
    ...
    public String toString(){ //me explicaron que esto es como imprimir
        String cadAux = "[X]";
        for (Nodo temp = this.topForward; temp != null; temp = temp.next){
            cadAux += " <- [ " + temp.name + " ] -> ";
        }
